...
export const VERSION_MODULE_SEEDS: VersionModuleSeed[] = [
  ...
  { module: '项目管理', scope: '项目详情 / 任务 / 成本核算', alpha: 'mock', beta: 'http', planned: ['合同/回款统一视图', '项目与线索同源上下文'], note: 'ProjectService mock/http；spawn 仍由 B3 Workers 写' },
  ...
  { module: '财务管理', scope: '财务统计 / 项目成本 / 工资表 / 开票审核', alpha: 'mock', beta: 'mock', planned: ['回款拆分/冲红权限矩阵', '全期次回款+开票视图', '回款逾期判断'], note: '实收台账 B4 已接 collections 表；看板/甘特图仍待回款看板计划' },
