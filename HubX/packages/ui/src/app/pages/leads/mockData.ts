...
const SAMPLED_LEADS: LeadListItem[] = [
  ...
  {
    key: 'assigned-5957', id: '5957', name: '社区生鲜小程序', customer: '', contact: '',
    phone: '', wechat: '', source: 'xiaohongshu', keyword: '生鲜小程序', status: '方案报价',
    ...
    lastFollowContent: '已发送 3.1 万元方案，正按预算收缩功能范围', nextFollowTime: '2026-08-30 10:00',
    followCount: 3, daysHeld: 2, remark: '社区生鲜零售小程序',
...
export const FOLLOWUP_RECORDS: FollowUpRecord[] = [
  {
    ...
    customerStatus: '方案报价',
    customerLevel: 'B',
    content: '已发送 3.1 万元方案，客户反馈预算偏高，正在收缩功能范围。',
