...
export const CONTRACT_TEMPLATE_VARIABLES = [
  'contractName', 'customerName', 'customerContact', 'customerPhone', 'customerTaxNo',
  'signingEntity', 'signDate', 'effectiveDate', 'endDate', 'totalAmount', 'contractContent',
] as const;
...
const seed: VersionedContractTemplate[] = [
  { id: 'tpl-zkrt-software', name: '软件开发服务合同', signingEntity: '中科软通', productCategories: ['软件开发', '系统集成'], status: 'published', isDefault: true, draftHtml: DEFAULT_BODY, versions: [{ id: 'tpl-zkrt-software-v1', versionNo: 1, html: DEFAULT_BODY, variables: ['contractContent', 'totalAmount', 'effectiveDate', 'endDate', 'customerName', 'signingEntity'], publishedAt: '2026-08-01T09:00:00.000Z', publishedBy: '黄海' }], updatedAt: '2026-08-01T09:00:00.000Z' },
